...
void GPIO_WritePin (PORT_NAME port_name , uint8_t pin_num , PIN_VALUE pin_state){
    ...
    case PORTB :
        if(pin_state == set){
            ...
            CLR_BIT(GPIO_PORTB_DATA_R,pin_num);
        }
        break;
    case PORTC :
        if(pin_state == set){
            ...
            CLR_BIT(GPIO_PORTC_DATA_R,pin_num);
        }
        break;
    case PORTD :
        if(pin_state == set){
            ...
            CLR_BIT(GPIO_PORTD_DATA_R,pin_num);
        }
        break ;
    case PORTE :
        if(pin_state == set){
            ...
            CLR_BIT(GPIO_PORTE_DATA_R,pin_num);
        }
        break ;
    case PORTF :
        if(pin_state == set){
            ...
            CLR_BIT(GPIO_PORTF_DATA_R,pin_num);
        }
        break ;
    }
}
